...
This vignette describes several use cases for retrieving substance information from zinc15.docking.org using the `Zn` R package.

To follow along, make sure Zn package is installed
